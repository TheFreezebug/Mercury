...
---LibCompress, decompressed Huffman
--@param compressed
...
---LibCompress, decompress uncompressed
--@param data
...
---LibCompress, Get addon encode table
...
---LibCompress, get chat endcode table
-- Addons: Call this only once and reuse the returned table for all encodings/decodings.
--@param reservesChars
--@param escapeChars
--@param mapChars
...
---LibCompress, fcs16init
function LibCompress:fcs16init()
        return FCSINIT16;
end

---LibCompress, fcs16update
--@param uFcs16
--@param pBuffer
...
---LibCompress, fcs32init
function LibCompress:fcs32init()
        return FCSINIT32;
end

---LibCompress, fcs32update
--@param uFcs32
--@param pBuffer
