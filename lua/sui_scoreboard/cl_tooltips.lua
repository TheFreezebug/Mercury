...
local function DrawTooltip( )
	...
	draw.RoundedBox( 0, x - 8 + 1, y - 4 + 1, w + 16, h + 9, Color( 0, 0, 0, alpha * 0.5 ) )
	draw.RoundedBox( 0, x - 8 + 2, y - 4 + 2, w + 18, h + 11, Color( 0, 0, 0, alpha * 0.25 ) )
	draw.RoundedBox( 0, x - 8 , y - 4, w + 16, h + 8, Color( 255, 250, 150, alpha ) )
